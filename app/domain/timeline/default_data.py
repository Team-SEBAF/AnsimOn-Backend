            ...
            "events": [
                ...
                },
                {
                    ...
                    "evidences": [
                        ...
                        {
                            "id": str(EVIDENCE_ID_14),
                            "index": 2,
                            "title": "음성 메시지 - 위협 내용",
                            "description": "스토킹범이 보낸 음성 메시지로, 피해자의 생명을 직접적으로 위협하는 내용이 포함되어 있다. 이 증거는 스토킹 사건의 심각성을 입증하는 결정적 자료가 된다.",
                            "tags": ["THREAT_COERCION", "PHYSICAL_HARM"],
                            "referenced_evidence_count": 1,
                            "has_thumbnail": False,
                            "thumbnail_url": "",
...
# timeline_evidence 더미: evidence_id는 위 EVIDENCE_ID와 동일, original_id는 placeholder (실제 evidence_ 테이블 id로 교체 예정)
# type: MESSAGE, VICTIM, VOICE, REPORT_RECORD, INCIDENT_LOG (골고루 분배)
DEFAULT_TIMELINE_EVIDENCES = [
    # EVIDENCE_ID_1: 카톡 및 메세지 (4)
    {
        "evidence_id": EVIDENCE_ID_1,
        "index": 1,
        "original_id": UUID("08e070bb-fb4e-4176-a450-375f947d1ef7"),
        "type": EvidenceType.MESSAGE,
    },
    {
        "evidence_id": EVIDENCE_ID_1,
        "index": 2,
        "original_id": UUID("584f7b54-992c-4888-b1fc-f265f9b7b817"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_1,
        "index": 3,
        "original_id": UUID("3d3b4007-89bd-4926-9227-7a8f46f9093a"),
        "type": EvidenceType.REPORT_RECORD,
    },
    {
        "evidence_id": EVIDENCE_ID_1,
        "index": 4,
        "original_id": UUID("38178693-ee87-4003-ba7d-3da9d47ed790"),
        "type": EvidenceType.INCIDENT_LOG,
    },
    # EVIDENCE_ID_2: 주거 인근 협박 경고장 (1)
    {
        "evidence_id": EVIDENCE_ID_2,
        "index": 1,
        "original_id": UUID("6de0bca2-6b96-4489-ab10-8e13033d40b0"),
        "type": EvidenceType.VICTIM,
    },
    # EVIDENCE_ID_3: 거절 의사 전달 (2)
    {
        "evidence_id": EVIDENCE_ID_3,
        "index": 1,
        "original_id": UUID("457329d6-d9e9-418a-9464-65f4fc7da8f8"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_3,
        "index": 2,
        "original_id": UUID("0abdd28e-7e14-4500-bb0a-4df16539e98b"),
        "type": EvidenceType.REPORT_RECORD,
    },
    # EVIDENCE_ID_4: 야간 협박 문자 (4)
    {
        "evidence_id": EVIDENCE_ID_4,
        "index": 1,
        "original_id": UUID("db9d9261-b523-4be9-9e9e-52ad6e75150e"),
        "type": EvidenceType.MESSAGE,
    },
    {
        "evidence_id": EVIDENCE_ID_4,
        "index": 2,
        "original_id": UUID("3ae78a06-8fb1-43ab-af55-032230585c94"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_4,
        "index": 3,
        "original_id": UUID("78be5c14-bfae-40a0-8bae-9159105c1748"),
        "type": EvidenceType.MESSAGE,
    },
    {
        "evidence_id": EVIDENCE_ID_4,
        "index": 4,
        "original_id": UUID("453628a0-f572-4db6-933e-07c04f1a3595"),
        "type": EvidenceType.INCIDENT_LOG,
    },
    # EVIDENCE_ID_5: 블랙박스 영상 (1)
    {
        "evidence_id": EVIDENCE_ID_5,
        "index": 1,
        "original_id": UUID("6a259984-0ba4-4d5e-b27b-55fb694eecbf"),
        "type": EvidenceType.VICTIM,
    },
    # EVIDENCE_ID_6: 카카오톡 대화 기록 (3)
    {
        "evidence_id": EVIDENCE_ID_6,
        "index": 1,
        "original_id": UUID("702eddc4-1eaf-4380-86dc-16b9bed5cf62"),
        "type": EvidenceType.MESSAGE,
    },
    {
        "evidence_id": EVIDENCE_ID_6,
        "index": 2,
        "original_id": UUID("b0904cd6-edee-4908-8054-1f55245fb89d"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_6,
        "index": 3,
        "original_id": UUID("bdc2123f-668f-4ae1-b49b-1b53710eb6b8"),
        "type": EvidenceType.VOICE,
    },
    # EVIDENCE_ID_7: 음성 메시지 녹음 (1)
    {
        "evidence_id": EVIDENCE_ID_7,
        "index": 1,
        "original_id": UUID("a1b29641-c680-43a5-a713-fa4842469960"),
        "type": EvidenceType.VOICE,
    },
    # EVIDENCE_ID_8: 출근길 추적 사진 (2)
    {
        "evidence_id": EVIDENCE_ID_8,
        "index": 1,
        "original_id": UUID("f15547c2-8278-4aa1-8422-add6ae43d368"),
        "type": EvidenceType.VICTIM,
    },
    {
        "evidence_id": EVIDENCE_ID_8,
        "index": 2,
        "original_id": UUID("38d5cd29-fc4a-46b0-8eeb-31f781aad1e5"),
        "type": EvidenceType.VICTIM,
    },
    # EVIDENCE_ID_9: 퇴근길 접근 시도 (1)
    {
        "evidence_id": EVIDENCE_ID_9,
        "index": 1,
        "original_id": UUID("2c504997-7042-4ac6-a8fe-cf42c31fbea4"),
        "type": EvidenceType.INCIDENT_LOG,
    },
    # EVIDENCE_ID_10: 협박 이메일 (1)
    {
        "evidence_id": EVIDENCE_ID_10,
        "index": 1,
        "original_id": UUID("f8166b42-1ffb-4c1f-a48d-8d2234476652"),
        "type": EvidenceType.REPORT_RECORD,
    },
    # EVIDENCE_ID_11: SNS 스토킹 사례 (5)
    {
        "evidence_id": EVIDENCE_ID_11,
        "index": 1,
        "original_id": UUID("83f41aee-f3a7-40d0-8740-080b7b0de4d5"),
        "type": EvidenceType.MESSAGE,
    },
    {
        "evidence_id": EVIDENCE_ID_11,
        "index": 2,
        "original_id": UUID("95d9b3ae-947a-458e-a7c4-767a6418ca8e"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_11,
        "index": 3,
        "original_id": UUID("74cccae8-5b38-4485-bf7c-eff37faa657e"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_11,
        "index": 4,
        "original_id": UUID("6964e84a-dec4-46d2-a4d3-7ac7a16d4d54"),
        "type": EvidenceType.INCIDENT_LOG,
    },
    {
        "evidence_id": EVIDENCE_ID_11,
        "index": 5,
        "original_id": UUID("3567e0ea-1593-4bf9-8fcb-24924b04fd81"),
        "type": EvidenceType.VOICE,
    },
    # EVIDENCE_ID_12: 경찰 신고 접수 (1)
    {
        "evidence_id": EVIDENCE_ID_12,
        "index": 1,
        "original_id": UUID("27556c3d-ad16-44f0-9a64-5bc28b0d1521"),
        "type": EvidenceType.INCIDENT_LOG,
    },
    # EVIDENCE_ID_13: 추가 협박 문자 (2)
    {
        "evidence_id": EVIDENCE_ID_13,
        "index": 1,
        "original_id": UUID("672626d0-21ac-4f95-8711-6b67105a06f2"),
        "type": EvidenceType.VOICE,
    },
    {
        "evidence_id": EVIDENCE_ID_13,
        "index": 2,
        "original_id": UUID("ffc7fa7b-8022-45cc-bbc0-5cbc2a38d8c0"),
        "type": EvidenceType.VOICE,
    },
    # EVIDENCE_ID_14: 음성 메시지 - 위협 내용 (1)
    {
        "evidence_id": EVIDENCE_ID_14,
        "index": 1,
        "original_id": UUID("91eaff7b-b5ed-4358-91b3-5bf2d6a0f66b"),
        "type": EvidenceType.VOICE,
    },
]
