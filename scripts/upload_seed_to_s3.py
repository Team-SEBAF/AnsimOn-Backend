...
def _s3_keys_from_seed() -> list[tuple[str, str]]:
    ...
    return [
        ...
        (f"{BASE}/victims/38d5cd29-fc4a-46b0-8eeb-31f781aad1e5/original", "image/png"),
        # evidence_voices
        (f"{BASE}/voices/584f7b54-992c-4888-b1fc-f265f9b7b817/original", "audio/mp4"),
        (f"{BASE}/voices/457329d6-d9e9-418a-9464-65f4fc7da8f8/original", "image/png"),
        (f"{BASE}/voices/3ae78a06-8fb1-43ab-af55-032230585c94/original", "image/png"),
        (f"{BASE}/voices/b0904cd6-edee-4908-8054-1f55245fb89d/original", "image/png"),
        (f"{BASE}/voices/bdc2123f-668f-4ae1-b49b-1b53710eb6b8/original", "image/png"),
        (f"{BASE}/voices/a1b29641-c680-43a5-a713-fa4842469960/original", "audio/mp4"),
        (f"{BASE}/voices/95d9b3ae-947a-458e-a7c4-767a6418ca8e/original", "image/png"),
        (f"{BASE}/voices/74cccae8-5b38-4485-bf7c-eff37faa657e/original", "audio/mp4"),
        (f"{BASE}/voices/3567e0ea-1593-4bf9-8fcb-24924b04fd81/original", "audio/mp4"),
        (f"{BASE}/voices/672626d0-21ac-4f95-8711-6b67105a06f2/original", "audio/mp4"),
        (f"{BASE}/voices/ffc7fa7b-8022-45cc-bbc0-5cbc2a38d8c0/original", "audio/mp4"),
        (f"{BASE}/voices/91eaff7b-b5ed-4358-91b3-5bf2d6a0f66b/original", "audio/mp4"),
        # evidence_report_records
        (f"{BASE}/report-records/3d3b4007-89bd-4926-9227-7a8f46f9093a/original", "application/pdf"),
        (f"{BASE}/report-records/0abdd28e-7e14-4500-bb0a-4df16539e98b/original", "application/pdf"),
        (f"{BASE}/report-records/f8166b42-1ffb-4c1f-a48d-8d2234476652/original", "application/pdf"),
        # evidence_incident_log_files (FILE 1개)
        (f"{BASE}/incident-logs/38178693-ee87-4003-ba7d-3da9d47ed790/original", "application/pdf"),
        # incident_log_form_data_attachments (2개)
        (
            f"{BASE}/incident-logs/attachments/2c504997-7042-4ac6-a8fe-cf42c31fbea4/9d4e5f6a-7b8c-4d9e-af01-23456789abcd/original",
            "image/png",
        ),
        (
            f"{BASE}/incident-logs/attachments/6964e84a-dec4-46d2-a4d3-7ac7a16d4d54/0e5f6a7b-8c9d-4e0f-a012-3456789abcde/original",
            "image/png",
        ),
    ]
